      ...
      <main className="ml-64 flex-1 min-h-screen overflow-auto">
        <div className="pt-20 pb-12 pl-8 pr-12">
            ...
            <div className="flex justify-between items-end mb-8">
                <div>
                    <h1 className={`text-3xl font-bold tracking-tight ${isDarkMode ? 'text-white' : 'text-slate-900'}`}>Broker Management</h1>
                    <p className={`mt-1 ${isDarkMode ? 'text-zinc-400' : 'text-slate-500'}`}>Manage your agents, track performance, and monitor commissions.</p>
                </div>
            ...
            <div className="flex flex-wrap items-center justify-between mb-6 gap-4">
                ...
                <div className="flex items-center gap-3">
                    <button className={`flex items-center gap-2 px-4 py-2.5 border font-medium rounded-lg shadow-sm transition-colors
                        ${isDarkMode 
                    ...
                    <button 
                        ...
                        className={`px-5 py-2.5 font-medium rounded-lg flex items-center gap-2 shadow-md transition-colors
                            ${isDarkMode 
