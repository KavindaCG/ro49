...
export default function Settings() {
    ...
    return (
        <main className="flex-1 min-h-screen overflow-auto pt-16 md:pt-20 pb-12 transition-all duration-300 md:ml-64">
            <div className="max-w-[1600px] mx-auto px-4 md:px-8 mt-6">
                ...
                <div className="mb-8 overflow-x-auto pb-2 -mx-4 px-4 md:mx-0 md:px-0">
                    <div className={`flex space-x-1 p-1 rounded-xl min-w-max md:min-w-0 ${isDarkMode ? 'bg-zinc-900' : 'bg-gray-100'}`}>
                        {['user-management', 'backup-settings', 'activity-logs', 'notification-settings'].map((tab) => (
                            <button
                                key={tab}
                                onClick={() => setActiveTab(tab)}
                                className={`px-4 md:px-6 py-3 rounded-lg font-medium transition-all duration-200 capitalize whitespace-nowrap ${getTabStyle(tab)}`}
                            >
                                {tab.replace('-', ' ')}
                            </button>
                        ))}
                ...
                <div>
                    ...
                    {activeTab === 'user-management' && (
                        <div className={`rounded-2xl shadow-sm border p-4 md:p-8 ${isDarkMode ? 'bg-[#18181b] border-zinc-800' : 'bg-white border-gray-200'}`}>
                            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
                                ...
                                <button className="w-full md:w-auto flex justify-center items-center bg-blue-600 text-white px-6 py-2 rounded-lg font-medium hover:bg-blue-700 transition-colors shadow-lg shadow-blue-500/20">
                            ...
                            <div>
                                ...
                                <div className="space-y-4">
                                    {/* Admin User */}
                                    <div className={`flex flex-col md:flex-row md:items-center justify-between p-6 rounded-xl border transition-colors gap-4
                            ${isDarkMode ? 'bg-zinc-900/50 border-zinc-800' : 'bg-gray-50 border-gray-200'}`}>
                                ...
                                ${isDarkMode ? 'bg-blue-500/20 text-blue-400' : 'bg-blue-100 text-blue-600'}`}>
                                        ...
                                        <div className="flex items-center justify-between md:space-x-6 w-full md:w-auto pl-16 md:pl-0">
