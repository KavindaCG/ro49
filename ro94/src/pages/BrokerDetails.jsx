            ...
            <main className="flex-1 min-h-screen overflow-auto pt-16 md:pt-20 pb-12 transition-all duration-300">
                ...
                ${isDarkMode
                    ...
                    <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 mb-8">
                        ...
                        <div className={`rounded-xl border shadow-sm p-6 xl:col-span-1
                    ...
                    <div className="md:hidden space-y-4">
                        <h3 className={`font-bold mb-2 ${isDarkMode ? 'text-white' : 'text-slate-800'}`}>Referral History</h3>
                            ...
                            <div key={client.id} className={`p-4 rounded-xl border shadow-sm ${isDarkMode ? 'bg-[#18181b] border-zinc-800' : 'bg-white border-gray-200'}`}>
                                <div className="flex justify-between items-start mb-3">
                                    <div>
                                        ...
                                        <p className={`text-xs font-mono opacity-60 ${isDarkMode ? 'text-zinc-400' : 'text-slate-500'}`}>{client.id}</p>
                                    </div>
                                    <span className={`inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-medium ${getClientStatusStyle(client.status)}`}>{client.status}</span>
                                </div>
                                <div className="grid grid-cols-2 gap-3 text-sm">
                                    <div className={`p-2 rounded-lg ${isDarkMode ? 'bg-zinc-900/50' : 'bg-gray-50'}`}>
                                        <div className={`text-xs opacity-60 mb-1 ${isDarkMode ? 'text-zinc-500' : 'text-slate-500'}`}>Investment</div>
                                        <div className={isDarkMode ? 'text-zinc-300' : 'text-slate-700'}>{client.investment}</div>
                                    </div>
                                    <div className={`p-2 rounded-lg ${isDarkMode ? 'bg-zinc-900/50' : 'bg-gray-50'}`}>
                                        <div className={`text-xs opacity-60 mb-1 ${isDarkMode ? 'text-zinc-500' : 'text-slate-500'}`}>Joined</div>
                                        <div className={isDarkMode ? 'text-zinc-300' : 'text-slate-700'}>{client.date}</div>
                                    </div>
                                </div>
                            </div>
                        ))}
