    ...
    <div className={`min-h-screen flex transition-colors duration-300 ${isDarkMode ? 'bg-[#09090b] text-zinc-100' : 'bg-gray-50 text-gray-900'}`}>
      ...
      <main className="ml-64 flex-1 min-h-screen overflow-auto">
        ...
        <div className="pt-20 pb-12">
          ...
          <div className="flex flex-col gap-6 mb-8 px-8">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
              ...
              <div className="flex items-center gap-4">
                ...
                <button className={`flex items-center gap-2 px-5 py-2.5 rounded-full text-sm font-medium transition-all shadow-sm hover:shadow-md
                  ${isDarkMode 
          ...
          {/* Table Section */}
          <div className="px-8">
            <div className={`w-full rounded-2xl overflow-hidden border shadow-sm transition-colors
