...
export default function ClientProfile() {
  ...
  return (
    // MAIN LAYOUT WRAPPER
    // Changed `pl-64` -> `pl-80` to create that requested gap between Sidebar and Content
    <div className="min-h-screen w-full pl-80 pt-28 pr-12 pb-12 bg-gray-50/50 text-gray-900 font-sans">
