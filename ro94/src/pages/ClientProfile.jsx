      ...
      <main className="flex-1 min-h-screen overflow-auto pt-16 md:pt-20 pb-12 transition-all duration-300">
        <div className="max-w-[1600px] mx-auto px-4 md:px-8 mt-6">
          ...
          <div className="flex flex-col xl:flex-row justify-between items-start xl:items-end gap-6 mb-12">
            ...
            <div className="flex flex-col md:flex-row items-center md:items-start gap-8 w-full md:w-auto">
              ...
              <div className="flex flex-col gap-2 items-center md:items-start text-center md:text-left">
                <div className="flex flex-col md:flex-row items-center gap-2 md:gap-4">
                  <h1 className={`text-4xl md:text-5xl font-bold tracking-tighter ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>
                    {clientData.name}
                  </h1>
                ...
                <div className={`flex flex-wrap justify-center md:justify-start items-center gap-4 md:gap-6 font-medium text-sm ${isDarkMode ? 'text-zinc-500' : 'text-gray-500'}`}>
                  ...
                  <div className={`hidden md:block w-px h-4 ${isDarkMode ? 'bg-zinc-800' : 'bg-gray-300'}`}></div>
                  <p className="flex items-center gap-2">
            ...
            <div className={`flex items-center gap-1 p-1.5 rounded-2xl border shadow-lg self-center xl:self-end overflow-x-auto max-w-full
              ${isDarkMode
...
function TabButton({ children, active, onClick, isDarkMode }) {
  return (
    <button
      onClick={onClick}
      className={`px-6 py-2 rounded-xl text-sm font-bold transition-all ${active
...
function DocAction({ icon: Icon, label, isDestructive, isDarkMode }) {
  return (
    <button
      className={`p-2 rounded-lg transition-colors ${isDestructive
